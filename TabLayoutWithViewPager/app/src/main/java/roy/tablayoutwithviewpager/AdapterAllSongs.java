...
class AdapterAllSongs extends RecyclerView.Adapter<AdapterAllSongs.SampleViewHolder>{
    ...
    public AdapterAllSongs(ArrayList<SubActivityModel> songs_list, InterfacePlaySongs artistsSubActivity, Activity activity) {
    ...
    public SampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdapterAllSongs.SampleViewHolder(itemView);
    }
