 ...
 * you may not use activity file except in compliance with the License.
...
public class AudioFxDemo extends Dialog {
    ...
    public AudioFxDemo(@NonNull Context context,MediaPlayer mediaPlayer) {
        super(context);
    ...
    /*    mMediaPlayer = MediaPlayer.create(activity, R.raw.test_cbr);*/
        ...
        // When the stream ends, we don't need to collect any more data. We don't do activity in
    ...
    private void setupVisualizerFxAndUI() {
        ...
        mVisualizerView.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.FILL_PARENT,
                (int)(VISUALIZER_HEIGHT_DIP * activity.getResources().getDisplayMetrics().density)));
